...
const data: FieldBus[] = [
  ...
  {
    name: "Visitor to Load Ratio",
    total: "92:1",
    pors: "13%",
    description: "vs previous 30 days",
  },
  {
    name: "Lead to Win Ratio",
    total: "5:1",
    pors: "7%",
    description: "vs previous 30 days",
  },
    ...
    <div className="w-[80%] h-full bg-gray-100 px-10">
      ...
      <div className="flex mb-4 gap-3">
        <div className="flex flex-col bg-white rounded-[.2rem] shadow-2xs p-1 pl-2 w-[30%]">
          <span className="text-[.7rem] text-gray-500 font-medium">
            Auto date range
          </span>
          <span className="text-[.9rem] font-medium flex items-center gap-1">
            {" "}
        ...
        <div className="flex flex-col bg-white rounded-[.2rem] relative shadow-2xs p-1 pl-2 w-[20%]">
          ...
          <IoMdArrowDropdown
            size={20}
            className="absolute right-1 top-4 text-gray-500  "
          />
        </div>
        <div className="flex flex-col bg-white rounded-[.2rem] relative shadow-2xs p-1 pl-2 w-[20%]">
      ...
      <div className="dad flex gap-4 ">
        {data &&
          data.map((item, index) => (
            <div
              key={index}
              className="bg-white p-5 rounded-xl shadow-2xs w-[25%]"
            >
              ...
              <div className="flex  flex-col items-center">
                ...
                <p className="text-[.7rem] text-gray-600 pt-8">
                  {item.description}
                </p>
              </div>
            </div>
