...
function EmailPassword() {
  ...
  return (
    <div className=" flex items-center flex-col justify-center w-[80%] h-full ">
      <h1 className="text-2xl font-bold mr-auto py-5 pl-10  ">
        Email & Password
      </h1>
      <div className=" w-[80%] h-full flex justify-center items-center">
        ...
        >
          <label>
            ...
            <input
              {...register("email")}
              className="border-b-1 border-gray-200 w-full p-2 outline-none"
              type="email"
          ...
          <button
            type="submit"
            className="ml-auto font-medium text-[.9rem] text-gray-500 "
          >
            {isSubmitting ? "...Updating" : "Edait"}
          </button>
        </form>
      </div>
    </div>
