...
function ProfileInfo() {
  ...
  const putProfile = useMutation({
    mutationFn: (response: FieldValues) =>
      fetch("http://localhost:3000/api/user/profile", {
        method: "PUT",
        headers: {
      ...
      >
        <div className="flex gap-8">
          <label className="w-full">
            <p className="text-[.9rem] font-medium pb-2">First Name</p>
            <input
              className="border-1 border-gray-300 p-3 w-full rounded-4xl"
              {...register("firstName")}
              type="text"
        ...
        <div className="flex gap-8">
          <label className="w-full">
            <p className="text-[.9rem] font-medium pb-2">Country</p>
            <input
              className="border-1 border-gray-300 p-3 w-full rounded-4xl"
              {...register("country")}
              type="text"
          ...
          <label className="w-full">
            <p className="text-[.9rem] font-medium pb-2">City</p>
            <input
              className="border-1 border-gray-300  p-3 w-full rounded-4xl"
              {...register("city")}
              type="text"
        ...
        <button
          type="submit"
          className="text-[.9rem] font-medium text-green-700 pr-5 absolute right-7 top-6 "
        >
          {isSubmitting ? "...saving change" : "save"}
        </button>
      </form>
      <LogOut />
    </div>
