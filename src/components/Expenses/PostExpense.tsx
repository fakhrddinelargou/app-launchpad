...
export default function PostExpense({ close }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2  ">
        ...
        >
          <option className="text-[1rem]" value="food">
            Food
          </option>
          <option className="text-[1rem]" value="entertainment">
            Entertainment
          </option>
          <option className="text-[1rem]" value="travel">
            Travel
          </option>
          <option className="text-[1rem]" value="health">
            Health
          </option>
